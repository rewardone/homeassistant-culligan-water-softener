...
class CulliganWaterSoftenerEntity(CoordinatorEntity[CulliganUpdateCoordinator], SensorEntity):
    """
        Softener Entity
    """
    def __init__(
    ...
    def device_info(self) -> DeviceInfo:
        ...
        return DeviceInfo(
            ...
            model=self.model,
            name=self.name,
            sw_version=self.softener.get_property_value("wifi_mcu_version") # should be device SW Version not wifi_mcu_version
        )
